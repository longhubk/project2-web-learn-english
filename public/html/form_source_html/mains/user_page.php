  ...
  <div class="user_info_page">
    ...
    <div class="output_info">
      <div class="user_avatar">
        <?php 
          $find_avatar= "SELECT avatar FROM users WHERE name='". $_COOKIE['member_login'] ."'";
          $avt = $connect->query($find_avatar);
          $fetch_avt = $avt->fetch(PDO::FETCH_ASSOC);
          $name_avt = $fetch_avt['avatar'];
